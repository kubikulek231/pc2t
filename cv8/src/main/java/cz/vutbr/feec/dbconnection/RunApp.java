...
public class RunApp {
  ...
  public static void main(String[] args) {
    ...
    while (run) {
      ...
      System.out.println("8 .. pridani nove role do systemu");
      System.out.println("9 .. nastaveni role");
      ...
      switch (choice) {
        ...
        case 8:
        	...
        	System.out.println("Zadejte roli pro pridani: ");
        	String role = sc.next();
        	insert.insertRole(role);
            break;
        case 9:
            InsertQueries setRole = new InsertQueries();
            System.out.println("zadej mail uzivatele");
            String mail = sc.next();
            System.out.println("zadej roli uzivatele");
            String role_ = sc.next();
            break;
        case 10:
          run = false;
