...
public class UpdateQueries {
  ...
  public void increase20PercentOfSalary(String email) {
    ...
    String update20PercentOfSalary = "update user set salary = 1.2 * salary where email = ?";
  ...
  public void addRole(String email, String role) {
	    ...
	    String addRole = "update user set role = ? where email = ?";

	    try (PreparedStatement prStmt = conn.prepareStatement(addRole);) {
	      prStmt.setString(1, role);
