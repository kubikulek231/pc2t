...
public class InsertQueries {
  ...
  public void insertRole(String role) {
	  if (role==null) {
		  throw new NullPointerException("Role musi byt nastavena");
	  }
	  String setRole = "insert into role (name) values(?)";
	  Connection conn = DBConnection.getDBConnection();
	  try {
		  PreparedStatement prStmt = conn.prepareStatement(setRole); 
